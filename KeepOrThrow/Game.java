...
public class Game extends JFrame {
	...
	private void initComponents() {
		...
		jPanel1 = new JPanel();
		jLabel1 = new JLabel("Mixed Stack", new ImageIcon("cards/0.png"), JLabel.CENTER);
		jLabel1.setVerticalTextPosition(JLabel.TOP);
		jLabel1.setHorizontalTextPosition(JLabel.CENTER);
		jLabel2 = new JLabel("Keep Stack", new ImageIcon("cards/0.png"), JLabel.CENTER);
		jLabel2.setVerticalTextPosition(JLabel.TOP);
		jLabel2.setHorizontalTextPosition(JLabel.CENTER);
		jLabel3 = new JLabel("Throw Stack", new ImageIcon("cards/0.png"), JLabel.CENTER);
	...
	public void updateLogic(){
		jLabel1.setIcon(new ImageIcon("cards/" + game.view() + ".png"));
		jLabel2.setIcon(new ImageIcon("cards/" + game.getKeepStack().peek().getValue() + ".png"));
		jLabel3.setIcon(new ImageIcon("cards/" + game.getThrowStack().peek().getValue() + ".png"));
	}
